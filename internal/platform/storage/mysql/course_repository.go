...
//CourseRepository is a MySQL mooc.CourseRepository implemetation
type CourseRepository struct {
	db *sql.DB
}

//NewCourseRepository() initializes a MYSQL-based implementation
...
//Save implements the mooc.CourseRepository
